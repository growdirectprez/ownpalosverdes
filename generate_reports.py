...
<section class="cta-bar">
  ...
  <form id="report-lead-form" class="report-lead" action="https://formspree.io/f/mwvapnan" method="POST">
    <input type="hidden" name="form_type" value="market_{year}-{month:02d}">
    <input type="hidden" name="report" value="{month_name} {year} Market Report">
    <input type="text" name="name" placeholder="Your name" required>
    <input type="email" name="email" placeholder="Email" required>
    <input type="tel" name="phone" placeholder="Phone (optional)">
    <button type="submit">Get My Market Analysis</button>
  </form>
  <div class="report-lead-msg" id="report-lead-msg"></div>
</section>
...
<script>
  ...
  formspree('initForm', {{
    formElement: '#report-lead-form', formId: 'mwvapnan',
    onSuccess: function () {{
      if (typeof gtag === 'function') {{
        gtag('event', 'generate_lead', {{ form_type: 'market_{year}-{month:02d}', form_id: 'mwvapnan' }});
      }}
      var f = document.getElementById('report-lead-form');
      var m = document.getElementById('report-lead-msg');
      if (f) {{ f.style.display = 'none'; }}
      if (m) {{ m.textContent = 'Thank you \\u2014 Angelique will be in touch shortly.'; m.style.display = 'block'; }}
    }}
  }});
</script>
